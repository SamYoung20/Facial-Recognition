function x = final_Eigen_smFace_Accuracy( )
%% 1. Load in Test Data
...
test_images_mouth= test_images(50:225,50:200,:);
...
%% 8. Find a Random Face and guess which face it is
    function [face1,face2] = guessWhichFace(index,meanFace, topX, K, centeredFaces,facesStacked,counter, names_test1, faces_test1)
        ...
        randomOriginal = faces_test(50:225,50:200,idx);
        reshRandom = faces_test(50:225,50:200, idx);
